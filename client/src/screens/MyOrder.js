...
export default function MyOrder() {
    ...
    return (
        <div style={{backgroundColor: "rgb(34, 34, 34)", color:"rgb(193 185 185)"}}>
            <div>
                <Navbar />
            </div>
                                                    ...
                                                    {arrayData.Order_date ? <div className='m-auto mt-5'>
                                                        ...
                                                        <div className='col-12 col-md-6 col-lg-3' >
                                                            <div className="card mt-3" style={{ width: "16rem", maxHeight: "360px" }}>
                                                                ...
                                                                <div className="card-body" style={{backgroundColor: "rgb(34, 34, 34)", color:"rgb(193 185 185)", border:".1px solid rgb(101 101 101)"}}>
